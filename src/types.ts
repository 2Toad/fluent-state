...
export type FailedTransitionHandler = (currentState: State, targetState: string) => void | Promise<void>;
export type AfterTransitionHandler = (previousState: State, currentState: State) => void | Promise<void>;

export type LifeCycleHandler = BeforeTransitionHandler | FailedTransitionHandler | AfterTransitionHandler;

export type EventHandler = (previousState: State, currentState: State) => void | Promise<void>;

export type EnterEventHandler = (previousState: State, currentState: State) => void | Promise<void>;
